...
// const message = `${1} has ${repairBots + defenceBots} bots in stock`;
...
// let weight = '88,3';
// let formattedWeight = Number(weight.replace(',', '.'))
// let height = Number('1.75');

// const bmi = formattedWeight / (height * height);
